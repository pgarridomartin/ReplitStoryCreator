...
export const books = pgTable("books", {
  ...
  facialFeatures: jsonb("facial_features").$type<string[]>(),
...
export const bookGenerationSchema = z.object({
  ...
  // Basic character customization (required)
  ...
  // Advanced character customization (optional)
  hairColor: z.string().optional(),
  eyeColor: z.string().optional(),
  clothingStyle: z.string().optional(),
  accessories: z.array(z.string()).max(3, "Maximum of 3 accessories").optional(),
  facialFeatures: z.array(z.string()).max(3, "Maximum of 3 facial features").optional(),
